#define BENCHMARK_NAME "CUDNN/CONV_BWD"
...
#define BENCHMARK_CUDNN(b)                                                                                             \
  BENCHMARK_TEMPLATE(b, CUDNN_CONVOLUTION_BWD_ALGO_IMPLICIT_GEMM)->CONV_PROBLEMS()->UseManualTime();                   \
  BENCHMARK_TEMPLATE(b, CUDNN_CONVOLUTION_BWD_ALGO_IMPLICIT_PRECOMP_GEMM)->CONV_PROBLEMS()->UseManualTime();           \
  BENCHMARK_TEMPLATE(b, CUDNN_CONVOLUTION_BWD_ALGO_GEMM)->CONV_PROBLEMS()->UseManualTime();                            \
  BENCHMARK_TEMPLATE(b, CUDNN_CONVOLUTION_BWD_ALGO_DIRECT)->CONV_PROBLEMS()->UseManualTime();                          \
  BENCHMARK_TEMPLATE(b, CUDNN_CONVOLUTION_BWD_ALGO_FFT)->CONV_PROBLEMS()->UseManualTime();                             \
  BENCHMARK_TEMPLATE(b, CUDNN_CONVOLUTION_BWD_ALGO_FFT_TILING)->CONV_PROBLEMS()->UseManualTime();                      \
  BENCHMARK_TEMPLATE(b, CUDNN_CONVOLUTION_BWD_ALGO_WINOGRAD)->CONV_PROBLEMS()->UseManualTime();                        \
  BENCHMARK_TEMPLATE(b, CUDNN_CONVOLUTION_BWD_ALGO_WINOGRAD_NONFUSED)->CONV_PROBLEMS()->UseManualTime()
